...
public class GUIProductsFind extends javax.swing.JDialog {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(rdoId.isSelected()){
            product.add(productService.findProductById(Long.parseLong(txtSearch.getText())));
        }else if(rdoName.isSelected()){
            product.add(productService.findProductByName(txtSearch.getText()));
        }else {
            product.addAll(productService.findByCategory(Long.parseLong(txtSearch.getText())));
        }
        fillTable(product);
