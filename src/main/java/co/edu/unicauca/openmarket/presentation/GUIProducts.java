...
public class GUIProducts extends javax.swing.JFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (txtName.getText().trim().equals("") || txtCategoria.getText().trim().equals("")) {
            Messages.showMessageDialog("Llene todos los campos", "Atención");
            txtName.requestFocus();
            return;
        }
        if (addOption) {
    ...
    private void btnCategoriasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCategoriasActionPerformed
        GUIProductsCategory instance = new GUIProductsCategory(this, true, categoryService);
        instance.setVisible(true);
    ...
    private void addProduct() {
        ...
        Long categoryId = Long.parseLong(txtCategoria.getText().trim());
    ...
    private void editProduct() {
        ...
        categoria.setCategoryId(Long.parseLong(txtCategoria.getText().trim()));
